package dev.openvta.logger.recording
...
import dev.openvta.logger.R
import dev.openvta.logger.OpenVtaLoggerApp
import dev.openvta.logger.domain.DistanceCalculator
...
class RecordingForegroundService : Service(), SensorEventListener, LocationListener {
    private lateinit var app: OpenVtaLoggerApp
    ...
    override fun onCreate() {
        super.onCreate()
        app = application as OpenVtaLoggerApp
    ...
    private fun buildNotification(content: String): Notification {
        ...
        return NotificationCompat.Builder(this, RECORDING_CHANNEL_ID)
            ...
            .setContentTitle("OpenVTA Logger")
    ...
    companion object {
        const val ACTION_START = "dev.openvta.logger.action.START_RECORDING"
        const val ACTION_STOP = "dev.openvta.logger.action.STOP_RECORDING"
        const val ACTION_PAUSE = "dev.openvta.logger.action.PAUSE_RECORDING"
