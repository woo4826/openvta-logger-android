...
- CI on `main` currently covers script validation, debug build, unit tests, and lint. Connected emulator and real-device QA are excluded from GitHub Actions CI and belong in the dedicated mobile QA thread.
...
- `.github/workflows/android-ci.yml`: script validation, debug build, unit tests, and lint only.
